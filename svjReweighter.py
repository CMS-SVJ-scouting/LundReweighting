...
def calculate_lund_weights(events, mc_year):
    ...
    # print("njets from flat jets", ak.count(jets_pt))
    # print("nconstituents flat", ak.count(constituentsFlat))
    # print("nconstituents", ak.count(constituents_pt))
    ...
    # print("number of actual weights", ak.count(output["nom"]))
